Welcome to the XIP&trade; Master Build Project!
===========================================================
...
This repository holds scripts that build the entire family of XIP projects.

The ultimate goals of the project include:

* Provide an integrated environment for building and installing XIP, including
  the AVT applications.
* Provide mechanisms for distributing the XIP framework and AVT
  applications.
